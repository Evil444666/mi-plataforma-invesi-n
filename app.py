...
if ejecutar_analisis and ticker_elegido:
    ...
    # PÁGINA DE BIENVENIDA (Dashboard Inicial con el TOP 10)
    ...
    if not top_df.empty:
        ...
        html_tabla += "<tr><th>TICKER</th><th>EMPRESA</th><th>PRECIO ACT.</th><th>OBJ. MEDIO</th><th>POTENCIAL</th><th>CONSENSO EXPERTO</th></tr>"
